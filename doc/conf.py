...
copyright = 'Kasper Welbers and Wouter van Atteveldt'
...
htmlhelp_basename = 'Orange3 SMA add-on documentation'
...
man_pages = [
    (master_doc, 'orange3-sma', 'Orange3 SMA Documentation',
     [author], 1)
]

'orange3-bioinformatics.tex', 'Orange3 Bioinformatics Documentation',
'Biolab', 'manual'),
